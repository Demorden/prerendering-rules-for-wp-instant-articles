...
function($overresult) {
	$override = get_field('override'); //change this according to your actual field name
		if ( $override = 1 ) { add_filter('wpinstant_prerendered_urls_override_defaults', '__return_true'); }
		else { add_filter('wpinstant_prerendered_urls_override_defaults', '__return_false'); }
};
